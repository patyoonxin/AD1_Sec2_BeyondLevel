...
const ProfilePage = ({ setUser: setGlobalUser }) => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
      <Navbar user={user} setUser={setGlobalUser} />
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="card fade-in">
          <div className="flex items-center space-x-5">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-500 text-sm mt-1">{user.email || 'No email added'}</p>
        ...
        <div className="card fade-in">
          <div className="flex items-center justify-between mb-5">
            ...
            {!showPasswordForm && (
              <button onClick={() => setShowPasswordForm(true)} className="btn btn-sm"
